...
@RestController
@Api(value = "API for My Mongo Services Claims Data")
@CrossOrigin(origins = "*")
...
public class ClaimDataController {
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "Able to Generate and fetch agent Successfully", response = Agent.class)})
